...
import type {
	...
	LearningJourneyRes,
	LearningJourneysRes,
} from "../types/learningJourney.js";

export const getAllLearningJourneys = async (
	req: Request,
	res: Response<LearningJourneysRes>,
) => {
	try {
...
export const getLearningJourneyById = async (
	req: Request<{ id: string }>,
	res: Response<LearningJourneyRes>,
) => {
	try {
		const { id } = req.params;
...
export const createLearningJourney = async (
	req: Request<{}, unknown, ILearningJourney>,
	res: Response<LearningJourneyRes>,
) => {
	try {
...
export const updateLearningJourney = async (
	req: Request<{ id: string }, unknown, ILearningJourney>,
	res: Response<LearningJourneyRes>,
) => {
	try {
		const { id } = req.params;
		...
		const updatedLearningJourney = await LearningJourney.findByIdAndUpdate(
			id,
			{ title, description, year, color, order },
...
export const deleteLearningJourney = async (
	req: Request<{ id: string }>,
	res: Response<LearningJourneyRes>,
) => {
	try {
